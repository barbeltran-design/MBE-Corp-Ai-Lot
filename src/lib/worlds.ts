...
export const SUBMUNDOS_ESTRATEGIA_LABELS = [
  ...
  { n: 1, icon: '🧭', ruta: '/babel/proposito', es: 'Propósito y Propuesta de Valor', en: 'Purpose and Value Proposition', estado: 'listo', esDesc: 'Se toma de la Misión 1 de la Reflexión Estratégica.', enDesc: 'Taken from Mission 1 of the Strategic Reflection.', pts: 25, sello: 'Estratega' },
