...
const CONTENT: Record<Language, Record<DimensionId, DimensionText>> = {
  es: {
    strategic: {
      ...
      levels: [
        ['Sé hacia dónde quiero llevar mi empresa y cuánto quiero ganar', 'Lista de actividades diarias o notas con los objetivos del mes'],
    ...
    finance: {
      ...
      levels: [
        ['Administro mis entradas y salidas de dinero para saber si me alcanza para pagar', 'Registro de la lista de entradas y salidas de dinero'],
    ...
    customerService: {
      ...
      levels: [
        ['Resuelvo los problemas de mis clientes en cuanto me llaman molestos', 'Correos o notas con reclamos recibidos'],
  ...
  en: {
    strategic: {
      ...
      levels: [
        ['I know where I want to take my company and how much I want to earn', 'List of daily activities or notes on monthly objectives'],
    ...
    finance: {
      ...
      levels: [
        ['I manage my cash inflows and outflows to ensure I have enough funds to cover payments', 'A log of cash inflows and outflows'],
    ...
    sales: {
      ...
      levels: [
        ['Sales come primarily from word-of-mouth recommendations', 'List of names of people who have referred clients to you'],
    ...
    customerService: {
      ...
      levels: [
        ['I resolve client issues as soon as they call with a complaint', 'Emails or notes containing received complaints'],
