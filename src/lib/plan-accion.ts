...
export const LABELS = {
  es: {
    ...
    verPlan: 'Ver ficha del proyecto',
    ...
    filtrarPorMentorLabel: 'Filtrar por mentor de IA',
    todosLosMentores: 'Todos',
    sinAccionesMentor: 'No hay acciones asignadas a este mentor todavia.',
    retosMentorTitulo: 'Retos pendientes de',
    retoDeLaSemanaLabel: 'Reto de la semana',
    retosMentorSinPendientes: 'Sin retos pendientes para este agente 🎉',
  },
  en: {
    ...
    filtrarPorMentorLabel: 'Filter by AI mentor',
    todosLosMentores: 'All',
    sinAccionesMentor: 'No actions assigned to this mentor yet.',
    retosMentorTitulo: 'Pending challenges for',
    retoDeLaSemanaLabel: 'Challenge of the week',
    retosMentorSinPendientes: 'No pending challenges for this agent 🎉',
  },
};
