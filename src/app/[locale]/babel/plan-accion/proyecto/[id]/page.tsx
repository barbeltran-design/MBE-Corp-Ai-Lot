...
import FichaProyectoBuilder from '@/components/babel/FichaProyectoBuilder';
...
export default function FichaProyectoPage() {
  ...
  const proyectoId = typeof params.id === 'string' ? params.id : '';
  ...
  return (
    <div className="px-4 py-8">
      <div className="mx-auto max-w-4xl">
        <FichaProyectoBuilder lang={localLang} proyectoId={proyectoId} />
      </div>
    </div>
  );
}
