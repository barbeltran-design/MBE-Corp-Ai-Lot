  ...
  const impulsores: Impulsor[] = [
    {
      ...
      notaCostos:
        lang === 'es'
          ? 'Gratis: diagnóstico, objetivos y acceso básico. Plan mensual: apoyo IA del estratega. On-Demand: apoyo de un especialista humano.'
          : 'Free: assessment, objectives and basic access. Monthly plan: AI strategist support. On-Demand: human expert support.',
      items: [
        ...
        { id: 'mejora', icono: LineChart, titulo: lang === 'es' ? 'Mejora del Nivel de Madurez' : 'Maturity Improvement', desc: lang === 'es' ? 'Prácticas mensuales y Scrum semanal para subir de nivel con cada agente.' : 'Monthly practices and weekly Scrum to level up with each agent.', costo: 'gratis', nota: lang === 'es' ? 'Con apoyo IA: Plan mensual · Con apoyo humano: On-Demand' : 'With AI support: Monthly plan · With human support: On-Demand', futuro: false, href: '/babel/madurez' },
        ...
        { id: 'reflexion', icono: Sparkles, titulo: lang === 'es' ? 'Reflexión estratégica' : 'Strategic Reflection', desc: lang === 'es' ? 'Alineación socioambiental de tu rumbo con Babel.' : 'Socio-environmental alignment of your direction with Babel.', costo: 'plan', nota: '', futuro: false, href: '/babel' },
        { id: 'organigrama', icono: Users, titulo: lang === 'es' ? 'Organigrama y Roles' : 'Org Chart & Roles', desc: lang === 'es' ? 'Define roles, responsables y tu directorio de contactos.' : 'Define roles, owners and your contacts directory.', costo: 'plan', nota: '', futuro: false, href: '/babel/organigrama' },
        { id: 'plan', icono: ClipboardList, titulo: lang === 'es' ? 'Plan de acción estratégico' : 'Strategic Action Plan', desc: lang === 'es' ? 'Especialistas con IA construyen tus acciones y factibilidad.' : 'Specialists with AI build your actions and feasibility.', costo: 'plan', nota: lang === 'es' ? 'Especialistas humanos: On-Demand' : 'Human specialists: On-Demand', futuro: false, href: '/babel/plan-accion' },
    ...
    },
    {
      ...
      notaCostos:
        lang === 'es'
          ? 'Gratis: directorio de convocatorias con búsqueda por perfil. Plan mensual: Reference Place. On-Demand: apoyo humano para aplicar y certificación.'
          : 'Free: calls directory with profile search. Monthly plan: Reference Place. On-Demand: human support to apply and certification.',
      items: [
        ...
        { id: 'apoyo-convo', icono: UserCheck, titulo: lang === 'es' ? 'Apoyo humano para aplicar' : 'Human support to apply', desc: lang === 'es' ? 'Un especialista te acompaña a postularte a las convocatorias correctas.' : 'A specialist walks you through the applications.', costo: 'ondemand', nota: '', futuro: true },
        { id: 'refplace', icono: Award, titulo: lang === 'es' ? 'Reference Place' : 'Reference Place', desc: lang === 'es' ? 'Referencias de tu proyecto ante fondos y comunidades certificadas.' : 'Project references with leading funds and certified businesses.', costo: 'plan', nota: '', futuro: true },
        { id: 'cert', icono: BadgeCheck, titulo: lang === 'es' ? 'Certificación MBE' : 'MBE Certification', desc: lang === 'es' ? 'Certificación y apoyo humano para lograr el sello de tu negocio.' : 'Certification and human support to earn your business badge.', costo: 'ondemand', nota: '', futuro: true },
      ],
    },
  ];
  ...
  return (
    <div>
      ...
      <p className="mt-8 text-[11px] text-slate-400">
        {lang === 'es'
          ? 'Los planes de pago se habilitarán próximamente. Hoy puedes usar toda la app.'
