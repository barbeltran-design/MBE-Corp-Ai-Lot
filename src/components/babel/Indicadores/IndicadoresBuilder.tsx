  ...
  React.useEffect(() => {
    try {
      ...
      if (rawPlan) {
        ...
        // Hidrata ~9 piezas de estado desde localStorage una sola vez al
        // montar (deps []); localStorage no existe en el server, no hay forma
        // de leerlo durante el render inicial. Cubre todo el bloque hasta linea 343.
