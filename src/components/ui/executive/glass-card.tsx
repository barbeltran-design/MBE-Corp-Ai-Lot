...
const glassCardVariants = cva(
  'relative rounded-2xl border border-glass-border bg-glass shadow-[0_20px_50px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-all duration-200 ease-executive',
  {
    variants: {
      interactive: {
