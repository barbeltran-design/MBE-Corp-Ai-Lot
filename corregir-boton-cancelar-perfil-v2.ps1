<#
========================================================================
 corregir-boton-cancelar-perfil.ps1  (v2 - corrige terminadores de linea)

 QUE HACE ESTE SCRIPT:

 Corrige src/app/[locale]/perfil/page.tsx para agregar el boton
 "Cancelar suscripcion" que quedo pendiente. La version anterior de
 este mismo script tenia un bug mio: al leer tu archivo real use un
 modo de Python que convertia los saltos de linea de Windows (\r\n) a
 saltos de Unix (\n) sin darme cuenta, asi que el texto que buscaba
 nunca coincidia con tu archivo real (que si usa \r\n). Esta version
 se genero preservando los saltos de linea exactos de tu archivo.
 ...
 Agrega:
   ...
   3) Un boton "Cancelar suscripcion" dentro de la tarjeta "Tu plan",
      visible solo cuando el usuario tiene el plan activo. Pide
